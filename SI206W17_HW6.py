...
class Student():
    ...
    def write_programs(self, number=1):
        self.num_programs += number 
...
## [PROBLEM 2]n the new list of accumulated -- mapped! -- values.
...
student_tups = zip(names, seniority)
...
g = zip(names, seniority, programs_written)
student_tups_list = list(g)
