...
#### You are required to define a class Movie. It should accept a dictionary that represents a movie and have 3 instance variables and 2 methods. You need to save the each movie by saving it in instance variable or a defining method that will compute these things: title, director, IMDB rating, list of actors, number of languages, and budget. 
...
Zootopia_info = Movie(mg[0], mg[1], mg[2], mg[3], mg[4], mg[5])
Oldboy_info = Movie(av[0], av[1], av[2], av[3], av[4], av[5])
...
print("\nInformation about the movies: Zootopia, Oldboy, and Inception\n\n")

print (Zootopia_info)
print (Oldboy_info)
print (Inception_info)

print("\n\n\n\nAre these movies good movies? (rating > 7 = good, 6-5 = average, < 5 = low rated)")
...
sorted_total_RTs = sorted(total_RTs, key = lambda x: x[1], reverse = True)


print("\n\n\nPopularity of Movie by number of retweets:")
for x in sorted_total_RTs:
...
f.write(str(Zootopia_info))
f.write(MGnumber)
f.write("\n\n\n")
f.write(str(Oldboy_info))
f.write(AVnumber)
f.write("\n\n\n")
...
class Testing(unittest.TestCase):
    ...
    def test_rating(self):
    	self.assertEqual("\nZootopia is a good movie.", str(MGnumber))
